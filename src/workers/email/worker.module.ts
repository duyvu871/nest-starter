...
import { bullEmailConfig } from './shared/queue/bull.config';
import { ConfigModule, ConfigService } from '@nestjs/config';
import { validateEnv } from 'app/config/env.validation';
import { appConfig, databaseConfig, emailConfig, jobsConfig, jwtConfig, rateLimitConfig, bullConfig, bullConfigFactory } from 'app/config';
